import { LOAD_INIT_DATA } from "../../actions/old";
import {
  UPDATE_VALUE_CHANGE,
  ON_UPDATE_PAGE_ID,
  ON_SET_LOADING,
  ...
  SET_STEPS_COMPLETED
} from "../../actions/old/actions";
import { ON_REMOVE_ERROR, ON_RESPONSE_ERROR } from "../../actions/old/error-actions";
...
} from "../../actions/old/requisition-actions";
import {
  GET_JOB_INFO,
  UPDATE_SCHEDULES,
  UPDATE_JOB_INFO,
...
} from "../../actions/old/application-actions";
