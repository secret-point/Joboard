...
import { TestInitUiState, TEST_APPLICATION_ID, TEST_APPLICATION_STATE, TEST_ASSESSMENT_STATE, TEST_CANDIDATE_STATE, TEST_JOB_ID, TEST_JOB_STATE, TEST_SCHEDULE_ID, TEST_SCHEDULE_STATE } from "../../../../test-utils/test-data";
