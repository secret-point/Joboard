...
export enum UPDATE_APPLICATION_ERROR_CODE {
    ...
    APPOINTMENT_NO_LONGER_AVAILABLE = "The appointment you selected is no longer available. Please select a different time.",
    CANDIDATE_ALREADY_HIRED = "Candidate already hired.",
    FAILED_SELECT_APPT_SHIFT = "Failed to update the application"
}
