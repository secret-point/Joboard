...
import { TimeoutPage } from "../../../../../src/components/us/timeout/Timeout";
    ...
    wrapper = mountWithStencil(
      <Provider store={store}>
        <Router history={history}>
          <TimeoutPage candidate={TEST_CANDIDATE_STATE} job={TEST_JOB_STATE} application={TEST_APPLICATION_STATE} />
        </Router>
      </Provider>
    );
  });
