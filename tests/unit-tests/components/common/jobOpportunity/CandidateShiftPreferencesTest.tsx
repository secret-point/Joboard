...
import ShiftPreferencesWithStore, {
  CandidateShiftPreferences
} from "../../../../../src/components/common/jobOpportunity/CandidateShiftPreferences";
...
describe("ShiftPreference Component", () => {
  ...
  it("should match snapshot", () => {
    const shallowWrapper = shallow(
      <CandidateShiftPreferences job={TEST_JOB} application={TEST_APPLICATION_DATA} candidate={TEST_CANDIDATE_STATE} />);
