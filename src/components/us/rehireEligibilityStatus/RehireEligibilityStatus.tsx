...
import { redirectToDashboard, resetIsPageMetricsUpdated } from "../../../helpers/utils";
...
import { getRehireNotEligibleStatusAdobePageName } from "../../../utils/helper";
...
export const RehireEligibilityStatus = (props: MapStateToProps) => {
  ...
  useEffect(() => {
    ...
    workflowErrorCode &&
    addMetricForPageLoad(getRehireNotEligibleStatusAdobePageName(workflowErrorCode));
  }, [workflowErrorCode]);
  ...
  useEffect(() => {
    return () => {
      ...
      workflowErrorCode &&
      resetIsPageMetricsUpdated(getRehireNotEligibleStatusAdobePageName(workflowErrorCode));
    };
  }, []);
