...
export enum FULL_BGC_STEPS {
  CONSENT = "CONSENT",
  BACKGROUND_INFO = "BACKGROUND_INFO",
  ADDRESS_HISTORY = "ADDRESS_HISTORY",
  BIRTH_HISTORY = "BIRTH_HISTORY",
  PROOF_OF_ID1 = "PROOF_OF_ID1",
  PROOF_OF_ID2 = "PROOF_OF_ID2",
...
export type INFO_CARD_STEPS = BGC_STEPS | SELF_IDENTIFICATION_STEPS | FULL_BGC_STEPS;
...
export enum CREATE_APPLICATION_ERROR_CODE {
  ...
  APPLICATION_ALREADY_EXIST_CAN_BE_RESET = "APPLICATION_ALREADY_EXIST_CAN_BE_RESET",
...
export enum GET_APPLICATIONS_BY_CANDIDATE_ID_ERROR_CODE {
  MISSING_REQUIRED_FIELDS = "MISSING_REQUIRED_FIELDS",
  UNABLE_TO_GET_APPLICATIONS = "UNABLE_TO_GET_APPLICATIONS",
  CANDIDATE_NOT_AUTHORIZED = "CANDIDATE_NOT_AUTHORIZED",
...
export enum GET_SCHEDULE_LIST_BY_JOB_ID_ERROR_CODE {
  ...
  NO_SCHEDULE_FOUND_ADJUST_FILTERS = "NO_SCHEDULE_FOUND_ADJUST_FILTERS"
}
...
export enum GET_NHE_TIME_SLOT_LIST_ERROR_CODE {
  ...
  VENUE_NOT_EXIST = "VENUE_NOT_EXIST"
}
...
export enum FEATURE_FLAG {
  ...
  ENABLE_THANK_YOU_REDIRECT_TO_ASH = "ENABLE_THANK_YOU_REDIRECT_TO_ASH",
}
...
export enum JOB_REFERRAL_VALUE {
  YES = "yes",
  NO = "no"
}
