...
export const actionUpdateCandidateShiftPreferencesRequest =
    (payload: CandidateShiftPreferences, onSuccess?: Function, onError?: Function ): UpdateCandidateShiftPreferencesAction => {
      return { type: CANDIDATE_ACTION_TYPES.UPDATE_CANDIDATE_SHIFT_PREFERENCES, payload, onSuccess, onError };
    };

export const actionUpdateCandidateShiftPreferencesSuccess = (payload: CandidateShiftPreferences): UpdateCandidateShiftPreferencesSuccessAction => {
  return {
